---
title: setTimeout, setInterval 사용 시 조심하세요
tag: Javascript
description: setTimeout, setInterval 잘 보고 사용하셔야 합니다.
...
setTimeout에서 반환 된 ID를 이용해 clearTimeout 함수에 넣으면 타이머를 취소할수도 있습니다.<br/>
...
```javascript
  ...
  const callback = () => {
    ...
    id = setTimeout(callback, 1000 - delay);
  };
